...
const INVENTORY_METADATA: Record<string, InventoryMetadata> = {
  ...
  "release:phase1:candidate-rehearsal": {
    purpose:
      "Run the full candidate rehearsal flow and stage reviewer front-door outputs, including Cocos primary journey evidence, the Cocos main-journey replay gate, Cocos primary diagnostics, the candidate revision triage digest derived from those checkpoints, the release readiness snapshot, the H5 candidate smoke report, the reconnect soak summary, the WeChat candidate summary, the runtime observability bundle and gate, the candidate-scoped Cocos RC bundle, the same-revision bundle's manifest, owner ledger, and dashboard, the release gate summary, the release health summary, the paired Phase 1 release evidence drift gate, the Phase 1 exit audit, the Phase 1 exit-dossier freshness gate, the Phase 1 candidate dossier, the final go/no-go packet, the candidate evidence audit, the dedicated freshness guard, its owner reminder and freshness history companions, the current evidence index, and the reviewer-facing release PR summary, into one release-readiness bundle directory.",
    requiredInputs: [
    ...
    producedArtifacts: [
      "Bundle directory under `artifacts/release-readiness/phase1-candidate-rehearsal/` with staged JSON/Markdown outputs, including Cocos primary journey evidence, the Cocos main-journey replay gate, Cocos primary diagnostics, the derived candidate revision triage input/digest pair, the release readiness snapshot, the staged H5 candidate smoke report, the staged reconnect soak summary, the staged WeChat candidate summary, the runtime observability bundle and gate, the candidate-scoped Cocos RC bundle, the restaged release-readiness dashboard, the same-revision evidence bundle manifest, the release gate summary, the release health summary, the paired Phase 1 release evidence drift gate, the Phase 1 exit audit, the Phase 1 exit-dossier freshness gate, the Phase 1 candidate dossier, the final go/no-go packet, the manual evidence owner ledger, the candidate evidence audit, the candidate evidence freshness guard, the candidate owner reminder and freshness history companions, the current evidence index, the reviewer-facing release PR summary, and a top-level `SUMMARY.md`.",
    ],
  },
