...
const INVENTORY_METADATA: Record<string, InventoryMetadata> = {
  ...
  "release:phase1:candidate-rehearsal": {
    ...
    producedArtifacts: [
      "Bundle directory under `artifacts/release-readiness/phase1-candidate-rehearsal/` with staged JSON/Markdown outputs, including Cocos primary journey evidence, the Cocos main-journey replay gate, Cocos primary diagnostics, the derived candidate revision triage input/digest pair, the restaged release-readiness dashboard, the paired Phase 1 release evidence drift gate, the Phase 1 exit audit, the Phase 1 exit-dossier freshness gate, the manual evidence owner ledger, the candidate evidence audit, the candidate evidence freshness guard, the candidate owner reminder and freshness history companions, the current evidence index, the final go/no-go packet, the reviewer-facing release PR summary, and a top-level `SUMMARY.md`.",
    ],
  },
