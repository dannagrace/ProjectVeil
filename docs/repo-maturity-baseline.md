...
| Add a single backlog ledger for manual-release evidence owners | Makes pending manual checks visible without opening several templates or JSON examples. | Landed via [`docs/release-evidence/manual-release-evidence-owner-ledger.template.md`](./release-evidence/manual-release-evidence-owner-ledger.template.md) plus tracked example [`artifacts/release-readiness/manual-release-evidence-owner-ledger-phase1-rc-abc1234.md`](../artifacts/release-readiness/manual-release-evidence-owner-ledger-phase1-rc-abc1234.md), which record owner, revision, timestamp, and follow-up for runtime, WeChat, and presentation sign-off evidence. |
