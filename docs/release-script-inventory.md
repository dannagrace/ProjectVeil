...
| `validate:k8s-image-tags` | validate | No tracked artifact; exits non-zero when a deployment image omits an explicit tag or digest. |
...
- Family: `release`
- Command: `npm run release -- candidate-triage:digest`
...
- Family: `release`
- Command: `npm run release -- candidate:evidence-audit`
...
- Family: `release`
- Command: `npm run release -- candidate:evidence:freshness-guard`
...
- Family: `release`
- Command: `npm run release -- cocos-rc:snapshot`
...
- Family: `release`
- Command: `npm run release -- cocos:main-journey-replay-gate`
...
- Family: `release`
- Command: `npm run release -- cocos:primary-diagnostics`
...
- Family: `release`
- Command: `npm run release -- cocos:primary-journey-evidence`
...
- Family: `release`
- Command: `npm run release -- cocos:rc-reconnect-replay`
...
- Family: `release`
- Command: `npm run release -- evidence:index`
...
- Family: `release`
- Command: `npm run release -- evidence:lifecycle`
...
- Family: `release`
- Command: `npm run release -- gate:summary`
...
- Family: `release`
- Command: `npm run release -- go-no-go-packet`
...
- Family: `release`
- Command: `npm run release -- health:trend-baseline`
...
- Family: `release`
- Command: `npm run release -- health:trend-compare`
...
- Family: `release`
- Command: `npm run release -- launch-compliance:gate`
...
- Family: `release`
- Command: `npm run release -- phase1:candidate-dossier`
...
- Family: `release`
- Command: `npm run release -- phase1:candidate-rehearsal`
...
- Family: `release`
- Command: `npm run release -- phase1:evidence-drift-gate`
...
- Family: `release`
- Command: `npm run release -- phase1:exit-audit`
...
- Family: `release`
- Command: `npm run release -- phase1:exit-dossier-freshness-gate`
...
- Family: `release`
- Command: `npm run release -- phase1:same-revision-evidence-bundle`
...
- Family: `release`
- Command: `npm run release -- pr-summary`
...
- Family: `release`
- Command: `npm run release -- production:rollback-drill`
...
- Family: `release`
- Command: `npm run release -- readiness:snapshot`
...
- Family: `release`
- Command: `npm run release -- reconnect-soak`
...
- Family: `release`
- Command: `npm run release -- runtime-observability:bundle`
...
- Family: `release`
- Command: `npm run release -- runtime-observability:evidence`
...
- Family: `release`
- Command: `npm run release -- runtime-observability:gate`
...
- Family: `release`
- Command: `npm run release -- runtime:slo-summary`
...
- Family: `release`
- Command: `npm run release -- same-candidate:evidence-audit`
...
- Family: `release`
- Command: `npm run release -- wechat:assets-hotfix`
...
- Family: `release`
- Command: `npm run release -- wechat:commercial-verification`
...
- Family: `release`
- Command: `npm run release -- wechat:install-launch-evidence`
...
- Family: `release`
- Command: `npm run release -- wechat:rehearsal`
...
- Family: `smoke`
- Command: `npm run smoke -- client:release-candidate`
...
- Family: `validate`
- Command: `npm run validate -- analytics-schema`
...
- Family: `validate`
- Command: `npm run validate -- content-smoke`
...
- Family: `validate`
- Command: `npm run validate -- e2e:fixtures`
...
- Family: `validate`
- Command: `npm run validate -- k8s-configmap`
...
- Family: `validate`
- Command: `npm run validate -- k8s-image-tags`
...
- Family: `validate`
- Command: `npm run validate -- production-env`
...
- Family: `validate`
- Command: `npm run validate -- quickstart:contract`
...
- Family: `validate`
- Command: `npm run validate -- redis-scaling`
...
- Family: `validate`
- Command: `npm run validate -- season-reward-config`
...
- Family: `validate`
- Command: `npm run validate -- wechat-build`
