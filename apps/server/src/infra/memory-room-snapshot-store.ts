...
import { applySeasonSoftDecay, decayDivisionToRating, getCurrentAndPreviousWeeklyEntries, resolveCompetitiveProgression } from "@server/domain/social/competitive-season";
...
export class MemoryRoomSnapshotStore implements RoomSnapshotStore {
  ...
  async getCurrentSeason(): Promise<import("@server/persistence").SeasonSnapshot | null> {
  ...
  async createSeason(seasonId: string): Promise<import("@server/persistence").SeasonSnapshot> {
