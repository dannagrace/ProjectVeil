...
- Locked the new reviewer entry with markdown assertions in `scripts/test/phase1-candidate-rehearsal.test.ts`.
- Updated the rehearsal docs and release script inventory so the reviewer packet description explicitly includes the WeChat candidate summary Markdown companion.

## Issue #1444 - Runtime gate markdown front door - 2026-04-13

- Frontloaded the staged `runtimeObservabilityGateMarkdownPath` into the `phase1-candidate-rehearsal` reviewer front door so reviewers can open the human-readable runtime gate companion directly from `SUMMARY.md`.
...
- Updated the rehearsal docs and release script inventory so the reviewer packet description explicitly includes the runtime observability gate Markdown companion.
...
- Locked the new reviewer entry with markdown and artifact-path assertions in `scripts/test/phase1-candidate-rehearsal.test.ts`.
- Updated the rehearsal docs and release script inventory so the reviewer packet description explicitly includes the CI trend summary Markdown companion.
...
- Locked the new reviewer entry with markdown and artifact-path assertions in `scripts/test/phase1-candidate-rehearsal.test.ts`.
- Updated the rehearsal docs and release script inventory so the reviewer packet description explicitly includes raw runtime observability evidence alongside the bundle and gate.
...
## Issue #1274 - Phase 1 rehearsal release gate front door - 2026-04-11

- 本轮把 `release-gate-summary` 提升成了 `release:phase1:candidate-rehearsal` 的显式 reviewer front door 入口：
  - `scripts/phase1-candidate-rehearsal.ts`
    - `SUMMARY.md` 的 reviewer front door 现在会直接列出：
      - `releaseGateSummaryPath`
- 文档与 inventory 已同步：
  - `docs/phase1-candidate-rehearsal.md`
    - 明确 rehearsal packet 会把 release gate summary 作为 packet-level reviewer checkpoint 前置展示
  - `scripts/release-script-inventory.ts` / `docs/release-script-inventory.md`
    - 同步更新 `release:phase1:candidate-rehearsal` 的职责与产物说明，包含 release gate summary front door
- 测试收口：
  - `scripts/test/phase1-candidate-rehearsal.test.ts`
    - 锁住 reviewer front door 对 `releaseGateSummaryPath` 的展示

## Issue #1276 - Phase 1 rehearsal release health front door - 2026-04-11

- 本轮把 `release-health-summary` 提升成了 `release:phase1:candidate-rehearsal` 的显式 reviewer front door 入口：
  - `scripts/phase1-candidate-rehearsal.ts`
    - `SUMMARY.md` 的 reviewer front door 现在会直接列出：
      - `releaseHealthSummaryPath`
- 文档与 inventory 已同步：
  - `docs/phase1-candidate-rehearsal.md`
    - 明确 rehearsal packet 会把 release health summary 作为 packet-level reviewer checkpoint 前置展示
  - `scripts/release-script-inventory.ts` / `docs/release-script-inventory.md`
    - 同步更新 `release:phase1:candidate-rehearsal` 的职责与产物说明，包含 release health summary front door
- 测试收口：
  - `scripts/test/phase1-candidate-rehearsal.test.ts`
